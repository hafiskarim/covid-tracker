...
const MapComponent = compose(
  ...
  <GoogleMap defaultZoom={5} defaultCenter={{ lat: 55.378051, lng: -3.435973 }}>
    {props.isMarkerShown && (
      <Marker position={{ lat: 55.378051, lng: -3.435973 }} />
    )}
  </GoogleMap>
));

class TabsEngland extends Component {
  componentDidMount() {
        ...
        <div className="d-flex justify-content-between mt-3">
          <div className="d-flex align-items-center flex-wrap">
            ...
            <div className="wrapper__tabsCountry">
              ...
              <p className="tabsCountry__total">
                {totalCasesByCountry
                  ? numberFormat(totalCasesByCountry[180].TotalConfirmed)
                  : null}
              </p>
            </div>
          </div>
          <div className="d-flex align-items-center flex-wrap">
            ...
            <div className="wrapper__tabsCountry">
              ...
              <p className="tabsCountry__total">
                {totalCasesByCountry
                  ? numberFormat(totalCasesByCountry[180].TotalRecovered)
                  : null}
              </p>
            </div>
          </div>
          <div className="d-flex align-items-center flex-wrap">
            ...
            <div className="wrapper__tabsCountry">
              ...
              <p className="tabsCountry__total">
                {totalCasesByCountry
                  ? numberFormat(totalCasesByCountry[180].TotalDeaths)
                  : null}
              </p>
            </div>
          </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(TabsEngland);
