...
const MapComponent = compose(
  ...
  <GoogleMap defaultZoom={5} defaultCenter={{ lat: 51.165691, lng: 10.451526 }}>
    {props.isMarkerShown && (
      <Marker position={{ lat: 51.165691, lng: 10.451526 }} />
    )}
  </GoogleMap>
));

class TabsGermany extends Component {
  componentDidMount() {
        ...
        <div className="d-flex justify-content-between mt-3">
          <div className="d-flex align-items-center flex-wrap">
            ...
            <div className="wrapper__tabsCountry">
              ...
              <p className="tabsCountry__total">
                {totalCasesByCountry
                  ? numberFormat(totalCasesByCountry[63].TotalConfirmed)
                  : null}
              </p>
            </div>
          </div>
          <div className="d-flex align-items-center flex-wrap">
            ...
            <div className="wrapper__tabsCountry">
              ...
              <p className="tabsCountry__total">
                {totalCasesByCountry
                  ? numberFormat(totalCasesByCountry[63].TotalRecovered)
                  : null}
              </p>
            </div>
          </div>
          <div className="d-flex align-items-center flex-wrap">
            ...
            <div className="wrapper__tabsCountry">
              ...
              <p className="tabsCountry__total">
                {totalCasesByCountry
                  ? numberFormat(totalCasesByCountry[63].TotalDeaths)
                  : null}
              </p>
            </div>
          </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(TabsGermany);
